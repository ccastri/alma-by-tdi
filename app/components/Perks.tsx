...
const Perks = () => {
  return (
    <div className='grid grid-cols-3 space-x-4 py-4 items-center justify-center w-full'>
      ...
      <a href="/collections/frontpage" className=' items-center   border-[#BB6A72] text-center flex flex-col text-[#BB6A72] hover:text-slate-300'><LoyaltyIcon className="w-16"/> Lo ultimo</a>
