...
<>
    ...
    <div className='w-full flex xs:flex-col items-center md:justify-between h-screen md:space-x-8 justify-center  md:px-20  md:h-full'>
      <div className='md:h-[50%] md:w-[60%]  '>
